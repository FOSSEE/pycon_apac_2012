...
{\centering {\includegraphics[scale=0.1]{pr.jpg}} \caption{Prof. Prabhu Ramachandran} \par}
\end{minipage}
\begin{minipage}[b]{0.5\linewidth}
%{\centering {\includegraphics[scale=0.1]{mb.png}} \caption{Prof. Madhu Belur} \par}
\end{minipage}
\end{figure} 
\end{frame}
...
\frametitle{Team}
\begin{figure}[ht]
{\centering {\includegraphics[scale=0.10]{team_new.JPG}} \caption{Say FOSSEE}}
\end{figure}
\end{frame}
